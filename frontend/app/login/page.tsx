...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      await signInWithGoogle('employer'); // Default to employer, can be changed
      router.push('/');
    } catch (err: any) {
  ...
  const handleGitHubLogin = async () => {
    ...
    try {
      await signInWithGitHub('freelancer'); // Default to freelancer, can be changed
      router.push('/');
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <p className="text-slate-400 mb-8">Sign in to your MilestoneAI account</p>
